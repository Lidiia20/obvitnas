...
<body>
                    ...
                    <div class="main-card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="mb-0">
                                        <i class="fas fa-shipping-fast me-2"></i>Detail Barang Keluar
                                    </h5>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="<?= base_url('satpam/barangkeluar') ?>" class="btn btn-light">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="detail-section">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="detail-row">
                                            <div class="detail-label">
                                                <i class="fas fa-user-check me-1"></i> Pemilik Barang
                                            </div>
                                            <div class="detail-value">
                                                <?= esc($barang['pemilik_barang']) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="detail-section">
                                <h6 class="section-title">
                                    <i class="fas fa-file-alt"></i>Informasi Surat & Dokumen
                                </h6>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label">
                                                <i class="fas fa-user-cog me-1"></i> Pejabat Penerbit Surat
                                            </div>
                                            <div class="detail-value <?= empty($barang['pejabat_penerbit_surat']) ? 'empty' : '' ?>">
                                                <?= esc($barang['pejabat_penerbit_surat']) ?: 'Tidak diisi' ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label">
                                                <i class="fas fa-file-contract me-1"></i> Nomor Surat
                                            </div>
                                            <div class="detail-value <?= empty($barang['no_surat']) ? 'empty' : '' ?>">
                                                <?= esc($barang['no_surat']) ?: 'Tidak diisi' ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="detail-section">
                                <h6 class="section-title">
                                    <i class="fas fa-box-open"></i>Informasi Barang
                                </h6>
                                
                                <div class="detail-row">
                                    <div class="detail-label">
                                        <i class="fas fa-sticky-note me-1"></i> Keterangan Barang
                                    </div>
                                    <div class="detail-value">
                                ...
                                <div class="photo-container">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <div class="detail-label">
                                                    <i class="fas fa-file-image me-1"></i> Foto Surat Jalan
                                                </div>
                                                <?php if ($barang['foto_surat_jalan']): ?>
                                                    <img src="<?= base_url('public/uploads/barang_keluar/' . $barang['foto_surat_jalan']) ?>" 
                                                         alt="Foto Surat Jalan" class="photo-large"
                                                         onclick="showImageModal('<?= base_url('public/uploads/barang_keluar/' . $barang['foto_surat_jalan']) ?>')">
                                                    <div class="mt-2">
                                                ...
                                                <?php else: ?>
                                                    <div class="no-photo">
                                                        ...
                                                        <p class="mb-0">Tidak ada foto surat jalan yang diupload</p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <?php if ($barang['foto_barang']): ?>
                                                    <img src="<?= base_url('public/uploads/barang_keluar/' . $barang['foto_barang']) ?>" 
                                                         alt="Foto Barang" class="photo-large"
                                                         onclick="showImageModal('<?= base_url('public/uploads/barang_keluar/' . $barang['foto_barang']) ?>')">
                                                    <div class="mt-2">
                                                        <small class="text-muted">Klik foto untuk memperbesar</small>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="no-photo">
                                                        <i class="fas fa-image fa-3x mb-3 text-muted"></i>
                                                        <p class="mb-0">Tidak ada foto barang yang diupload</p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <div class="detail-section">
                                <h6 class="section-title">
                                    <i class="fas fa-user-shield"></i>Petugas Satpam Pemeriksa
                                </h6>
                            ...
                            <div class="print-section text-center">
                                ...
                                <a href="<?= base_url('satpam/barangkeluar') ?>" class="btn btn-secondary">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-image me-2"></i>Foto Barang Keluar - Detail
                    </h5>
    ...
    <script>
        ...
        window.addEventListener('beforeprint', function() {
            document.title = 'Detail Barang Keluar - ID ' + <?= $barang['id'] ?> + ' - ' + '<?= esc($barang['nama_instansi']) ?>';
        });
