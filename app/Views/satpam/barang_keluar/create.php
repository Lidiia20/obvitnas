...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="main-card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="header-title">
                                    <i class="fas fa-shipping-fast me-2"></i>FORMULIR PENGENDALIAN BARANG KELUAR
                                </h5>
                        ...
                        <div class="card-body">
                            <?= form_open_multipart(base_url('satpam/barangkeluar/store'), ['id' => 'barangKeluarForm']) ?>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="mb-3">
                                        <label for="pemilik_barang" class="form-label required">
                                            <i class="fas fa-user-check"></i>Pemilik Barang
                                        </label>
                                        <input type="text" name="pemilik_barang" 
                                               class="form-control <?= $validation && $validation->hasError('pemilik_barang') ? 'is-invalid' : '' ?>" 
                                               id="pemilik_barang" placeholder="Masukkan nama pemilik barang" 
                                               value="<?= old('pemilik_barang') ?>" required>
                                        <?php if ($validation && $validation->hasError('pemilik_barang')): ?>
                                            <div class="invalid-feedback"><?= $validation->getError('pemilik_barang') ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    <div class="section-title">
                                        <i class="fas fa-file-alt me-2"></i>Informasi Surat & Dokumen
                                    </div>

                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="pejabat_penerbit_surat" class="form-label">
                                                <i class="fas fa-user-cog"></i>Pejabat Penerbit Surat
                                            </label>
                                            <input type="text" name="pejabat_penerbit_surat" class="form-control" 
                                                   id="pejabat_penerbit_surat" placeholder="Masukkan nama pejabat" 
                                                   value="<?= old('pejabat_penerbit_surat') ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="no_surat" class="form-label">
                                                <i class="fas fa-file-contract"></i>Nomor Surat
                                            </label>
                                            <input type="text" name="no_surat" class="form-control" 
                                                   id="no_surat" placeholder="Masukkan nomor surat" 
                                                   value="<?= old('no_surat') ?>">
                                        </div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="foto_surat_jalan" class="form-label required">
                                            <i class="fas fa-file-image"></i>Foto Surat Jalan
                                        </label>
                                        <div class="file-input-wrapper">
                                            <input type="file" name="foto_surat_jalan" id="foto_surat_jalan" 
                                                   accept="image/*" onchange="handleFileSelect(this, 'preview_surat')" required>
                                            <label for="foto_surat_jalan" class="file-input-label">
                                                <i class="fas fa-cloud-upload-alt"></i>
                                                Pilih atau seret file foto surat jalan
                                                <small class="d-block text-muted mt-1">Format: JPG, PNG, GIF (Max: 4MB)</small>
                                            </label>
                                        </div>
                                        <?php if ($validation && $validation->hasError('foto_surat_jalan')): ?>
                                            <div class="invalid-feedback"><?= $validation->getError('foto_surat_jalan') ?></div>
                                        <?php endif; ?>
                                        <div id="preview_surat" class="mt-2"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="keterangan_barang" 
                                                  ...
                                                  placeholder="Deskripsikan barang yang keluar secara detail..."><?= old('keterangan_barang') ?></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="file-input-wrapper">
                                            <input type="file" name="foto_barang" id="foto_barang" 
                                                   accept="image/*" onchange="handleFileSelect(this, 'preview_barang')" required>
                                        ...
                                        <?php endif; ?>
                                        <div id="preview_barang" class="mt-2"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    <div class="section-title">
                                        <i class="fas fa-user-shield me-2"></i>Verifikasi Satpam
                                    </div>

                                    <div class="mb-3">
                                        <label for="satpam_pemeriksa" class="form-label required">
                                            <i class="fas fa-user-shield"></i>Nama Satpam Pemeriksa
                                        </label>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <a href="<?= base_url('satpam/barangkeluar') ?>" class="btn btn-secondary px-4">
    ...
    <script>
        ...
        function resetFileInput(input, previewId) {
            const label = input.parentElement.querySelector('.file-input-label');
            const labelText = input.id === 'foto_surat_jalan' ? 'Pilih atau seret file foto surat jalan' : 'Pilih atau seret file foto barang';
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.key === 'Escape') {
                if (confirm('Apakah Anda yakin ingin keluar? Data yang belum disimpan akan hilang.')) {
                    window.location.href = '<?= base_url('satpam/barangkeluar') ?>';
                }
            }
        });
    </script>
